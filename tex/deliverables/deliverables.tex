...
\begin{itemize}[label=\textbullet]
		...
		%Vasiliy thinks this is too much.
		...
		%Perform detailed study of static vacuum pressure distribution in and around the IR and begin investigating the vacuum hardware design to fit the physics constraints.  This is necessary to achieve an accurate estimate of beam-gas event rates in the detectors.  Furthermore, this study underlies vacuum pump placement and begins an iterative design process in collaboration with the machine design group, especially with regards to beam pipe design.
